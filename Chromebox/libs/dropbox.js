...
(function() {
  var Dropbox, LocalStorage, OAuthClient, OAuthClients, ROOT_PATH, URL, toQueryString,
  ...
  window.resolvePendingClients = function() {
    var client, token, token_secret, _i, _len, _ref, _ref1, _results;
    _ref = LocalStorage.get("oauth_token", "oauth_token_secret"), token = _ref[0], token_secret = _ref[1];
    _results = [];
    for (_i = 0, _len = OAuthClients.length; _i < _len; _i++) {
      client = OAuthClients[_i];
      if (((_ref1 = client.deferred) != null ? _ref1.state() : void 0) === "pending") {
        client.oauth.setAccessToken(token, token_secret);
        _results.push(client.deferred.resolve());
      } else {
  ...
  OAuthClient = (function() {
    ...
    OAuthClient.prototype._fetchAccessToken = function() {
      ...
      success = function() {
        ...
        closeTab();
        return (_ref2 = chrome.extension.getBackgroundPage()) != null ? _ref2.resolvePendingClients() : void 0;
      };
      error = function(response) {
