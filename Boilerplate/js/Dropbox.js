...
(function() {
  var CONSUMER_KEY, CONSUMER_SECRET, Dropbox, OAuthClient, ROOT_PATH, Tokens, URL, buildUrl, escapePath, toQueryString,
  ...
  toQueryString = function(obj) {
    var encode, key, param, params, value;
  ...
  Dropbox = (function(_super) {
    ...
    Dropbox.prototype.request = function(success, failure, target, data, method, contentHost, headers) {
      var host, url;
      if (data == null) {
        data = {};
      }
    ...
    Dropbox.prototype.get_file = function(success, failure, path, params) {
      return this.request(success, failure, "/files/" + this.root + "/" + path, params, "GET", true);
    };

    Dropbox.prototype.put_file = function(success, failure, path, params, fileData) {
      var headers, target;
      target = buildUrl("/files_put/" + this.root + "/" + path, params);
      headers = {
        "Content-Type": "text/plain"
      };
      return this.request(success, failure, target, fileData, "PUT", true, headers);
    };
    ...
    Dropbox.prototype.metadata = function(success, failure, path, params) {
      ...
      return this.request(success, failure, target, params);
    };

    Dropbox.prototype.delta = function(success, failure, params) {
      var target;
      target = "/delta";
      return this.request(success, failure, target, params, "POST");
    };

    Dropbox.prototype.revisions = function(success, failure, path, params) {
      var target;
      if (path == null) {
        path = "";
      }
    ...
    Dropbox.prototype.restore = function(success, failure, path, params) {
      var target;
      if (path == null) {
        path = "";
      }
    ...
    Dropbox.prototype.shares = function(success, failure, path, params) {
      var target;
      if (path == null) {
        path = "";
      }
    ...
    Dropbox.prototype.media = function(success, failure, path, params) {
      var target;
      if (path == null) {
        path = "";
      }
    ...
    Dropbox.prototype.copy_ref = function(success, failure, path, params) {
      var target;
      if (path == null) {
        path = "";
      }
    ...
    Dropbox.prototype.thumbnails = function(success, failure, path, params) {
      var target;
      if (path == null) {
        path = "";
      }
      target = "/thumbnails/" + this.root + "/" + path;
      return this.request(success, failure, target, params, "GET", true);
    };
